/**
 * Sprite Animation Bundle for ECSpresso
 *
 ...
 *
 * Renderer2D is a required dependency — the `sprite` component comes from that bundle.
 * This bundle declares only `spriteAnimation` as its component type.
 */
...
/**
 * Component types provided by the sprite animation bundle.
 */
...
export interface SpriteAnimationBundleOptions<G extends string = 'spriteAnimation'> {
...
/**
 * Create a sprite animation bundle for ECSpresso.
 *
 * Provides:
 ...
 * - Sprite texture sync via structural cross-bundle access
...
>(
	...
	function processFrameAdvancement(
		...
		ecs: {
			...
			eventBus: { publish: (event: any, data: any) => void };
 ...
 * following the tween bundle's cross-component pattern.
 */
