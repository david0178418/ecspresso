/**
 * Coroutine Bundle for ECSpresso
 *
...
export interface CoroutineBundleOptions<G extends string = 'coroutines'> {
...
export interface CoroutineKit<W extends AnyECSpresso, G extends string = 'coroutines'> {
	bundle: Bundle<CoroutineComponentTypes<EventsOfWorld<W>>, EventsOfWorld<W>, {}, {}, {}, 'coroutine-update', G>;
	createCoroutine: (
		generator: CoroutineGenerator,
 ...
 * @returns A kit object with bundle, createCoroutine, waitForEvent
 */
export function createCoroutineKit<W extends AnyECSpresso, G extends string = 'coroutines'>(
	options?: CoroutineBundleOptions<G>,
): CoroutineKit<W, G> {
	return {
		bundle: createCoroutineBundle<EventsOfWorld<W>, G>(options),
...
/**
 * Create a coroutine bundle for ECSpresso.
 *
 ...
 */
export function createCoroutineBundle<ET extends Record<string, any> = Record<string, any>, G extends string = 'coroutines'>(
	options?: CoroutineBundleOptions<G>,
): Bundle<CoroutineComponentTypes<ET>, ET, {}, {}, {}, 'coroutine-update', G> {
	const {
	...
	return bundle as Bundle<CoroutineComponentTypes<ET>, ET, {}, {}, {}, 'coroutine-update', G>;
}
