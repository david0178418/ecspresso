...
function createTestEcs() {
	...
	const ecs = ECSpresso
		...
		.withBundle(createAudioBundle({ channels: testChannels }))
...
describe('Audio Bundle Type Tests', () => {
...
describe('Audio Bundle Integration', () => {
	test('bundle registers audioState resource', async () => {
